...
CREATE VIEW public.cvt1 AS
 SELECT DISTINCT acto.caso_id,
  ...
  WHERE ((caso.fecha >= '2007-05-31'::date) AND (caso.fecha <= '2023-06-09'::date) AND (categoria.id = ANY (ARRAY[197, 777, 297, 397, 527, 427, 776, 196, 296, 396, 526, 426, 35, 55, 45, 25, 15, 73, 65, 92, 40, 50, 67, 801, 90, 26, 16, 46, 37, 57, 80, 85, 66, 64, 703, 28, 18, 706, 49, 59, 38, 501, 401, 904, 402, 502, 331, 231, 17, 705, 62, 906, 104, 713, 101, 21, 11, 76, 302, 27, 34, 903, 102, 902, 24, 301, 14, 30, 20, 10, 522, 192, 392, 292, 422, 772, 63, 93, 910, 525, 295, 775, 425, 195, 395, 714, 78, 524, 394, 194, 294, 774, 424, 89, 905, 86, 701, 68, 341, 241, 141, 715, 704, 702, 23, 43, 13, 53, 33, 88, 98, 84, 709, 711, 707, 708, 710, 87, 97, 717, 917, 716, 916, 91, 95, 718, 393, 193, 423, 773, 293, 523, 48, 58, 75, 69, 41, 74, 22, 12, 47, 56, 36, 72, 291, 521, 391, 771, 421, 191, 520, 420, 77, 39, 29, 19, 712])));
